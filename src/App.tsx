        ...
        >
          <AuthProvider>
            <Routes>
              ...
              <Route path="/dashboard/text-to-video/editor/:projectId" element={<><SEO title="Text to Video Timeline Editor" description="Edit scenes, captions, timeline layers, and render text-to-video projects." path="/dashboard/text-to-video/editor" noindex /><RequireAuth><TextToVideo /></RequireAuth></>} />
